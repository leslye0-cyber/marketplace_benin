    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banniere', models.ImageField(blank=True, null=True, upload_to='shops/bannieres/')),
                ('telephone', models.CharField(blank=True, max_length=20)),
                ('adresse', models.TextField(blank=True)),
                ...
                ('vendeur', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='shop', to=settings.AUTH_USER_MODEL)),
            ],
            options={
